package com.hungerfool.stockwatcher.domain;
...
@Entity
@Table(name = "stockwatcher")
public class StockWatcher extends BaseEntity {
	...
	public StockWatcher(String stockCode, String email, Double highThreshold, Double lowThreshold) {
		super();
	...
	public boolean equals(Object obj) {
		if (obj == null || !(obj instanceof StockWatcher)) {
			return false;
		}
		if (this == obj) {
			return true;
		...
		StockWatcher other = (StockWatcher) obj;
